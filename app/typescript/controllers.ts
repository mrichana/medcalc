module controllers{
    ...
    export class calculatorCtrl {
      public static $inject = ['$scope', '$location', 'views', 'internalMedicineViews', 'pulmonologyViews','cardiologyViews', 'triplexViews'];
      constructor (private $scope: ICalculatorScope
        , private $location: ng.ILocationProvider
        , private views
        , private internalMedicineViews
        , private pulmonologyViews
        , private cardiologyViews
        , private triplexViews)
        {
            $scope.filters = [
                {   id: 'All',
                    name: 'Όλοι',
