...
(function() {
    ...
    factory('internalMedicineCalculators', function(mathParser, roundNum, evaluator) {
        return {
            abg: function(values) {
            ...
            crusade: function(values) {
                ...
                if (probability[result] >= 30) {
                    resultlevel = 3;
                } else if (probability[result] >= 20) {
                    resultlevel = 2;
                } else if (probability[result] >= 10) {
                    resultlevel = 1;
                } else {
                    resultlevel = 0;
                }
